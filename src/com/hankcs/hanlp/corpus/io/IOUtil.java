...
import static com.hankcs.hanlp.utility.GlobalParams.IOAdapter;
...
public class IOUtil
{
    ...
    public static class LineIterator implements Iterator<String>, Iterable<String>
    {
        ...
        public LineIterator(BufferedReader bw)
        {
            ...
            {
                logger.warning("在读取过程中发生错误" + GlobalParams.exceptionToString(e));
                bw = null;
            }
        }
        ...
        public void close()
        {
            ...
            {
                logger.warning("关闭文件失败" + GlobalParams.exceptionToString(e));
            }
            return;
        }
